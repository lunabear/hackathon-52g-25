    ...
    answer: (
      <div className="space-y-3">
        ...
        <div className="space-y-2 text-xs md:text-sm lg:text-base">
          ...
          GenAI의 이미지 분석 기술을 활용하여 안전조회시 사전에 재해 발생 할 수 있는 인원에 대한 알람을 주는 아이디어</p>
          ...
          L&L 자료가 Database화가 되어져 있지만, 사용자가 잘 활용하지 않고, 찾는 것에 어려움이 있으므로, GenAI를 통해서 반복되는 유사문제에 대해서 쉽고 빠르게 검색하여 사고 예방을 할 수 있도록 경각심을 주는 아이디어</p>
        </div>
      </div>
    )
  }
