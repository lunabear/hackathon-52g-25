      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2 text-xs md:text-sm lg:text-base">
          ...
          <p>
            ...
            <br />
            회의 안건에 대하여 GenAI의 분석과 요약을 바탕으로 의사결정의 정확도를 높이는 업무 효율화 아이디어
          </p>
          <p>
            <strong>GS파워 &lt;sAIfety&gt;</strong>
            <br />
            위험성 평가 결과 자료를 GenAI를 활용하여 분석시간을 단축하고, 평가의 신뢰를 높이는 아이디어
          </p>
          <p>
            <strong>GS엔텍 &lt;제제고&gt;</strong>
            <br />
            Database화가 되어있는 L&L 자료를 GenAI를 통해서 반복되는 유사문제에 대해서 쉽고 빠르게 검색하여 사고 예방을 할 수 있도록 경각심을 주는 아이디어
          </p>
        </div>
      </div>
    ),
